...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-24 00:21`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ab110e3d-cf5c-4935-b42d-f01fc35fe3ff.git
$ cd ab110e3d-cf5c-4935-b42d-f01fc35fe3ff
```
